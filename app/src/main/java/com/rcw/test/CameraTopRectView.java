...
//    private static final int BOTTOM_BTN_HEIGHT = Constant.RECT_VIEW_BOTTOM;
    ...
    public CameraTopRectView(Context context, AttributeSet attrs) {
        ...
        viewHeight = panelHeght - (int) DisplayUtils.dp2px(activity,TOP_BAR_HEIGHT + BOTTOM_BTN_HEIGHT);
...
//        rectWidth = panelWidth - DisplayUtils.dp2px(activity,LEFT_PADDING + RIGHT_PADDING);
//        rectHeght = (int) (rectWidth * 54 / 85.6);

        rectWidth = 500;
        rectHeght = 720;
        // 相对于此view
        rectTop = (viewHeight - rectHeght) / 2-160;
    ...
    public void onDraw(Canvas canvas) {
        ...
        //底部阴影
        rect = new Rect(0, viewHeight/2+rectHeght/2-160, viewWidth, viewHeight);
        canvas.drawRect(rect, wordPaint);
        //上部
        rect = new Rect(0, 0, viewWidth, viewHeight/2-rectHeght/2-160);
        canvas.drawRect(rect, wordPaint);
        //左
        rect = new Rect(0, viewHeight/2-rectHeght/2-160, (viewWidth-rectWidth)/2, viewHeight/2+rectHeght/2-160);
        canvas.drawRect(rect, wordPaint);
        //右
        rect = new Rect(viewWidth-(viewWidth-rectWidth)/2, viewHeight/2-rectHeght/2-160, viewWidth, viewHeight/2+rectHeght/2-160);
        canvas.drawRect(rect, wordPaint);
